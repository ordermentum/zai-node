...
export interface Item {
    ...
    /** @example 22000 */
    status?: 22000 | 22100 | 22110 | 22150 | 22175 | 22180 | 22195 | 22190 | 22200 | 22300 | 22400 | 22410 | 22420 | 22500 | 22575 | 22600 | 22610 | 22650 | 22670 | 22700 | 22800 | 22680;
    /** @example 20000 */
    amount?: number;
    /** @example 2 */
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    directDebitAuthorities: {
         ...
         * @secure
         */
        listDirectDebitAuthorities: (query: {
            account_id: string;
            limit?: number;
            offset?: number;
